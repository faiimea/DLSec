...
if __name__ == "__main__":
    ...
    if attack_mode=="Badnets":
        Badnets_params = {
            ...
            'local_model_path': "20231130-143924-Badnetcifar100pretrained.pth",  # LocalModels下相对路径
        ...
        WaNet_params = {
            ...
            'optimizer': 'sgd',
            'criterion': torch.nn.CrossEntropyLoss(),
            'local_model_path': "20231201-224929-WaNetCifar10.pth",  # LocalModels下相对路径
            's': 0.5,
            'k': 4,
            'noise_ratio': 0.2
        }
