...
def options():
    ...
    parser.add_argument('--attackiter', default=200, type=int) # origin:250
    ...
    parser.add_argument('--restarts', default=8, type=int, help='How often to restart the attack.') # origin:8
